  ...
  return (
    <>
      <ul className="socials-wrap">
        <Socials
          text="linkedin"
          to="https://www.linkedin.com/in/theadnan/"
          dimenssion={dim}
          fontSize={size}
        />
        <Socials
          text="facebook"
          to="https://www.facebook.com/adnan.joiya.muhammadi/"
          dimenssion={dim}
          fontSize={size}
        />
        <Socials
          text="instagram"
          to="https://www.instagram.com/adnan.muhammadi/"
          dimenssion={dim}
          fontSize={size}
        />
        <Socials
          text="github"
          to="https://github.com/adnan-muhammadi"
          dimenssion={dim}
          fontSize={size}
        />
      </ul>
